...
public abstract class AbstractGarbageCompositeTest {

  protected GarbageCompositeCompilerRunner runner;
  ...
  protected void setup() throws Exception {
    runner = new GarbageCompositeCompilerRunner(getInitialContext());
  }
  ...
  protected void initSourcePath(final GarbageCompositeCompilerRunner runner,
